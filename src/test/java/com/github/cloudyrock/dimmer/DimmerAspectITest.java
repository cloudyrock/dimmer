...
public class DimmerAspectITest extends DimmerTestBase {
    ...
    public void featureAndDefaultException() {
        dimmerProcessor.featureWithBehaviour(FEATURE_AND_DEFAULT_EXCEPTION, exceptionBehaviour);
        dummyClass.featureAndDefaultException();
    }

    @Test(expected = DummyException.class)
    public void featureAndCustomException() {
        dimmerProcessor.featureWithBehaviour(FEATURE_AND_CUSTOM_EXCEPTION, exceptionBehaviour);
    ...
    class AnnotatedClass {
        ...
        @DimmerFeature(value = ALWAYS_OFF, behaviour = THROW_EXCEPTION, disabled = true)
        ...
        @DimmerFeature(value = FEATURE_AND_DISABLED, behaviour = THROW_EXCEPTION, disabled = true)
        String featureAndDisabled() {
            return REAL_VALUE;
        }

        @DimmerFeature(value = ALWAYS_OFF, disabled = true)
