...
public class FeatureProcessorLocalUTest {
    ...
    @Mock
    private Function<FeatureInvocationLocal, String> behaviour;

    @Mock
    private FeatureInvocationLocal featureInvocationMock;
...
//    }
    ...
    public void ensureFeatureInvocationParameterWhenBehaviour() throws Throwable {
        given(behaviour.apply(any(FeatureInvocationLocal.class)))
    ...
    public void ensureFeatureInvocationParameterWhenException() throws Throwable {
        ...
        FeatureInvocationLocal featureInvocationMock = mock(FeatureInvocationLocal.class);
        given(behaviour.apply(any(FeatureInvocationLocal.class)))
                .willReturn("not_checked");
